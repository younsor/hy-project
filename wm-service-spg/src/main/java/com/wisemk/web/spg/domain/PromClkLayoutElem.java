...
/**
 * The persistent class for the prom_clk_layout_elem database table.
 * 
 */
@Entity
@Table(name = "prom_clk_layout_elem")
@NamedQuery(name = "PromClkLayoutElem.findAll", query = "SELECT p FROM PromClkLayoutElem p")
public class PromClkLayoutElem implements Serializable
{
